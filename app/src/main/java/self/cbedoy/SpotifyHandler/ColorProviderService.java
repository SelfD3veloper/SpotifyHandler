...
public class ColorProviderService
{
    ...
    public void decorateImage(Bitmap bitmap) {
        mBitmap = Bitmap.createScaledBitmap(bitmap, 200, 200, false);
        analyzeImage();
    }
    ...
    private void analyzeImage() {
        ...
        if (mPrimaryColor == null) {
            LogService.e("Unable to detect primary color in image");
        ...
        if (mSecondaryColor == null) {
            LogService.e("Unable to detect secondary in image");
            if (hasDarkBackground) {
        ...
        if (mDetailColor == null) {
            LogService.e("Unable to detect detail color in image");
            if (hasDarkBackground) {
    ...
    public class HashBag<self> extends HashMap<self, Integer> {

        public HashBag() {
            super();
        }

        public int getCount(self value) {
            if (get(value) == null) {
                return 0;
            } else {
                return get(value);
